                    ...
                    {data.map((item, index) => (
                        <div className="p-6 border border-1 rounded-2xl" key={index}>
                            ...
                            <div className="flex gap-3">
                                <p className="text-[#23BE0A] text-base font-medium bg-[#23BE0A0D] rounded-full py-2 px-4"><span>{item.tags[0]}</span></p>
                                <p className="text-[#23BE0A] text-base font-medium bg-[#23BE0A0D] rounded-full py-2 px-4"><span>{item.tags[1]}</span></p>
                            </div>
                            <div className="mt-4">
                            ...
                            <div className="mt-5 flex justify-between ">
                                ...
                                <p className="text-base font-medium text-[#131313CC] flex justify-center items-center gap-1"><span>{item.rating}</span> <CiStar /> </p>
                            </div>
                        </div>
